...
export type VideoSubtitleData = { name: string, lang: string }

export async function getThisVideoSubtitlePath(originalFilePath: string): Promise<VideoSubtitleData[]> {
  ...
  let subtitleFilePaths: VideoSubtitleData[] = []
